...
<!-- Main Content -->
  ...
  <!-- Topbar -->
    <div class="container">
      <div class="row">
        <h2 class="est-title-cont"><span class="est-text-title">PERMIT PER ESTABLISHMENT (PENDING)</span></h2>
      </div>
                ...
                <!-- <div class="form-group row dp_section-options">
                    ...
                    <div class="col-sm-3" style="text-align:center">
                     ...
                     <div class="form-group row dp_section-row<?=$estval['cnt']?>">
                       <input type="hidden" name="upload_req_id" value="" id="upload_new_req_id">
                       ...
                       <div class="col-md-2"><input type="file" value="" id="uploadpermitnewdp" class="uploadpermitnewdp"></div>
                        <div class="col-md-1">
                          <button type="button" name="button" class="btn-primary" onClick="Crs.upload_new_attachment('1',this)"><i class="fa fa-upload" aria-hidden="true"></i></button>
                        </div>
                     </div>
                     <div class="form-group row dp_section">
                       ...
                       <div class="col-md-2" style="display:contents">
                         <!-- <button type="button" name="button" class="btn-primary dp_btn" value="dp_section-row<?=$estval['cnt']?>" ><i class="fa fa-plus" aria-hidden="true" ></i></button> -->
                     ...
                     <!-- for cnc -->
                            ...
                            <div class="col-md-12 mb-3 text-center">
                              ...
                              <div class="form-group row cnc_section-row">
                                ...
                                <div class="col-md-1"><button type="button" name="button" class="btn-primary" onClick="Crs.upload_new_attachment('2',this)"><i class="fa fa-upload" aria-hidden="true"></i></button></div>
                              </div>
                            ...
                            <div class="col-md-12 mb-3 text-center">
                             ...
                             <div class="multiple_ecc_permits_data"></div>
                                ...
                                <div class="form-group row ecc_section-row">
                                  ...
                                  <div class="col-md-1"><button type="button" name="button" class="btn-primary" onClick="Crs.upload_new_attachment('3',this)"><i class="fa fa-upload" aria-hidden="true"></i></button></div>
                                </div>
                         ...
                         <div class="form-group row po_section-row">
                           ...
                           <div class="col-md-1"><button type="button" name="button" class="btn-primary" onClick="Crs.upload_new_attachment('4',this)"><i class="fa fa-upload" aria-hidden="true"></i></button></div>
                         </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    if (selected_company != '') {
      ...
      Crs.view_company_permits(selected_company,this);
    }
