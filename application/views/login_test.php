            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url(); ?>Login/validate_login_test" method="post" id="client_login">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url(); ?>Login/rest_pass">Forgot Password?</a> |
                        <a class="small" href="<?php echo base_url(); ?>User">Create an Account</a><br><br>
                  </div>
                  <div class="text-center">
