<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="https://iis.emb.gov.ph/support/Message_center/verify_user_acc/?user_code=<?php echo $this->session->userdata('user_code');?>" target="_blank">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">SUPPORT</span>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="https://iis.emb.gov.ph/smr/login/verify_user_registration/?user_code=<?php echo $this->session->userdata('user_code');?>" target="_blank">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">SMR</span>
                <i class="fas fa-plus fa-sm fa-fw mr-2 text-gray-400"></i>
              </a>
              <!-- Dropdown - User Information -->
            </li>
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="<?php echo base_url()?>/Dashboard/dashboard">
